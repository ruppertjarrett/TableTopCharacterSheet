...
public class CharacterSheet {
    ...
    /**
     * @param name name property of weapon
     * @return null if no weapons or no match found
     */
    ...
    /**
     * @param name name property of Armor
     * @return null if no armor or no match found
     */
    ...
    /**
     * @param name name property of item
     * @return null if no items or no match found
     */
    ...
    /**
     * @param name name property of spell
     * @return null if no spells or no match found
     */
    ...
    /**
     * @param name name property of ability
     * @return null if no abilities or no match found
     */
